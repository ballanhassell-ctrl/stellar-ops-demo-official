...
export const LiquidGlassBackground = () => {
  ...
  const backgroundClassName = isDark
    ? 'liquid-glass-bg liquid-glass-bg-dark'
    : 'liquid-glass-bg';
  const videoClassName = isDark
    ? 'video-backdrop-container video-backdrop-dark'
    : 'video-backdrop-container video-backdrop-light';
  const overlayClassName = isDark
    ? 'liquid-glass-overlay liquid-glass-overlay-dark'
    : 'liquid-glass-overlay';
  const vignetteClassName = isDark
    ? 'liquid-glass-vignette liquid-glass-vignette-dark'
    : 'liquid-glass-vignette';
    ...
    <>
      ...
      <div className={videoClassName}>
        <div className="video-backdrop-masked">
          <video autoPlay loop muted playsInline className="video-backdrop-video">
