...
export function calculateVCCSummary(payments: VCCPayment[]): VCCPaymentsSummary {
  ...
  return {
    ...
    declinedAmount: declined.reduce((s, p) => s + p.payment_amount, 0),
